...
public class AccountController {
    ...
    public ResponseEntity<Void> createAccount(HttpServletRequest httpServletRequest, @RequestBody Account newAccount) {
        ...
        var uri = ServletUriComponentsBuilder.fromRequestUri(httpServletRequest)
                .pathSegment("{accountId}").buildAndExpand(account.getEntityId()).toUri();

        var uri2 = entityWithLocation(account.getEntityId());
     ...
     */
    private URI entityWithLocation(Object resourceId) {
    ...
    public ResponseEntity<Void> addBeneficiary(@PathVariable long accountId, @RequestBody String beneficiaryName) {
        ...
        var uri2 = entityWithLocation(beneficiaryName);
