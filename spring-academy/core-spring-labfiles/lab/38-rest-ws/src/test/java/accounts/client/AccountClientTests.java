...
public class AccountClientTests {
    ...
    public void addAndDeleteBeneficiary() {
        ...
        var newBeneficiaryUri = restTemplate.postForLocation(BASE_URL + "/accounts/1/beneficiaries", "David", Beneficiary.class);

        // TODO-14: Retrieve the Beneficiary you just created from the location that was returned
        Beneficiary newBeneficiary = restTemplate.getForObject(newBeneficiaryUri, Beneficiary.class);

        assertNotNull(newBeneficiary);
        assertEquals("David", newBeneficiary.getName());

        // TODO-15: Delete the newly created Beneficiary
       restTemplate.delete(newBeneficiaryUri);
        ...
        restTemplate.getForObject(newBeneficiaryUri, Beneficiary.class);
