...
public class AccountControllerBootTests {
	...
	public void accountDetailsFail() throws Exception {
		...
		given(accountManager.getAccount(any(Long.class)))
				.willThrow(new IllegalArgumentException("No such account with id " ));
		...
		mockMvc.perform(get("/accounts/124")).andExpect(status().isNotFound());

		verify(accountManager).getAccount(124L);
