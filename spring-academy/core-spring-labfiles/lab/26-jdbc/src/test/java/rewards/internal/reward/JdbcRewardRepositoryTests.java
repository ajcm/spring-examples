...
public class JdbcRewardRepositoryTests {
    ...
    private void verifyRewardInserted(RewardConfirmation confirmation, Dining dining) throws SQLException {
        ...
        Map<String, Object> values = jdbcTemplate.queryForObject(sql,

                (rs, rowNum) -> {

                    Map<String, Object>  map = new HashMap<>();

                    map.put("REWARD_AMOUNT", rs.getBigDecimal("REWARD_AMOUNT"));
                    map.put("REWARD_DATE", rs.getDate("REWARD_DATE"));
                    map.put("ACCOUNT_NUMBER", rs.getString("ACCOUNT_NUMBER"));
                    map.put("DINING_AMOUNT", rs.getBigDecimal("DINING_AMOUNT"));
                    map.put("DINING_MERCHANT_NUMBER", rs.getString("DINING_MERCHANT_NUMBER"));
                    map.put("DINING_DATE", rs.getDate("DINING_DATE"));
    ...
    private int getRewardCount() throws SQLException {
        ...
        var count = jdbcTemplate.queryForObject("SELECT count(*) FROM T_REWARD", Long.class);
