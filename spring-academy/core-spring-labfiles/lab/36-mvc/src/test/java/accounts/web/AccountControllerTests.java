...
public class AccountControllerTests {
	...
	public void testHandleDetailsRequest() {
		...
		var accountFromController = controller.getAccountDetails(expectedAccountId);
		...
		assertNotNull(accountFromController);
		assertEquals(expectedAccountId, (long) accountFromController.getEntityId());
		assertEquals(expectedAccountNumber,  accountFromController.getNumber());
